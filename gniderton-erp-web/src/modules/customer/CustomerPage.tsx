...
import { Plus, Users, CheckCircle2, Clock, Search, Bell, MapPin, Filter, RefreshCcw } from 'lucide-react'
  ...
  return (
    <div className="space-y-6 w-full h-full flex flex-col">
      ...
      <div className="flex-1 overflow-hidden flex flex-col space-y-4">
        <div className="glass-card p-4 rounded-xl border border-[#e6e9ee] bg-white shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between w-full mb-2">
          ...
          <div className="flex flex-wrap gap-3 w-full md:w-auto items-center justify-end">
            ...
            {(search || filterDSE || filterRoute || filterChannel) && (
              <button
                onClick={() => {
                  setSearch('')
                  setFilterDSE('')
