...
const pageName = 'Sales Order';

let out = '--- SALES ORDER PAGE ARCHITECTURE ---\n';
...
fs.writeFileSync('sales_order_blueprint.txt', out, 'utf8');
console.log('Finished writing Sales Order blueprint.');
