...
async function aggressiveCleanup() {
    ...
    try {
        ...
        console.log("--- STARTING AGGRESSIVE MASTER CLEANUP ---");
        ...
        for (const brokenId of brokenIds) {
            ...
            if (clean.rows.length > 0) {
                ...
                console.log(`Repointing ${brokenId} -> ${cleanId} (Aggressive Match)`);
                ...
                console.log(`No aggressive twin found for ${brokenId}, healing instead...`);
