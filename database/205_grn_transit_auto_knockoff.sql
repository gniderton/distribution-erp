-- ============================================================
-- Migration 205: GRN Transit Auto-Knockoff
-- 
-- Modifies create_purchase_invoice to detect negative 
-- transit batches and automatically knock them off using 
-- the incoming GRN stock. Updates the old transit batch
-- metadata (batch code, expiry, etc.) to match the new GRN.
-- ============================================================
