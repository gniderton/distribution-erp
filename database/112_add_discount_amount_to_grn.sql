-- Migration: Add discount_amount to purchase_invoice_lines
ALTER TABLE purchase_invoice_lines ADD COLUMN discount_amount NUMERIC DEFAULT 0;
...
BEGIN
    ...
    LOOP
        ...
        VALUES (
            ...
            (v_line->>'discount_amount')::numeric, (v_line->>'scheme_amount')::numeric, 
