...
let out = '--- INVENTORY PAGE ARCHITECTURE ---\n';
...
// Find JS Objects connected to the page
...
fs.writeFileSync('inventory_blueprint.txt', out, 'utf8');
console.log('Finished writing Inventory blueprint.');
